...
create table compras (compraId varchar(40) NOT NULL, usuario varchar(20)NOT NULL FOREIGN KEY REFERENCES usuarios(usuario), conciertoId varchar(40) NOT NULL FOREIGN KEY REFERENCES conciertos(id), fecha datetime NOT NULL, cantidad INT NOT NULL, precio float NOT NULL, PRIMARY KEY (compraId, conciertoId, precio))